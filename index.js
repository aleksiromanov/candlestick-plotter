...
var SCV_FILE_PATH = 'DAT_ASCII_EURUSD_M1_201902-100.csv';
var LABLEL_FOR_BUY = 'B';
var LABLEL_FOR_SELL = 'S';
var LABLEL_FOR_HOLD = 'H';

var TicksPlotter = function () {
    function TicksPlotter() {
        _classCallCheck(this, TicksPlotter);
    }

    _createClass(TicksPlotter, [{
        key: 'analyse_input',
        ...
        value: function run() {
            ...
            var ticks = [];
            _fs2.default.createReadStream(SCV_FILE_PATH).pipe((0, _csvParse2.default)({ 'delimiter': ';' })).on('data', function (tick) {
